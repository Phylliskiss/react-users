  ...
  render() {
    return (
        ...
        <Form.Group className="mb-3" controlId="formBasicEmail">
          ...
          <Form.Control type="text" placeholder="Enter name" name="name" onChange={this.userChange}/>
        </Form.Group>
  
        <Form.Group className="mb-3" controlId="formBasicPassword">
          <Form.Label>Email address</Form.Label>
          <Form.Control type="email" placeholder="Enter email" name="email" onChange={this.userChange}/>
        </Form.Group>
        <Form.Group className="mb-3">
          <Form.Label>Gen</Form.Label>
          <Form.Control type="text" placeholder="enter gen" name="gen" onChange={this.userChange}/>
        </Form.Group>
